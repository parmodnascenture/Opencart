...
class ControllerExtensionModuleTestimonial extends Controller {
    ...
    public function index() {
        ...
        if (isset($this->request->get['testimonial_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $module_info = $this->model_setting_module->getModule($this->request->get['testimonial_id']);
        }
    ...
    protected function validate() {
        ...
        if (!$this->request->post['name']) {
            $this->error['name'] = $this->language->get('error_width');
        }

        if (!$this->request->post['email']) {
            $this->error['email'] = $this->language->get('error_height');
        }
